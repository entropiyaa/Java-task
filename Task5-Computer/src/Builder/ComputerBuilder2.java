...
public class ComputerBuilder2 extends Builder {
    ...
    public void buildArrayOfStandard() {
        ...
        arrStandard.add(StandardCPU.STANDARD_8);
        arrStandard.add(StandardHDD.STANDARD3);
        arrStandard.add(StandardHDD.STANDARD4);
        arrStandard.add(StandardMotherboard.ST1);
        arrStandard.add(StandardPowerSupply.STANDARD_6);
        arrStandard.add(StandardRAM.STANDARD_8);
